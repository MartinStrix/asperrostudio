            ...
            <div>
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="group relative w-10 h-10 rounded-xl bg-white/5 overflow-hidden flex items-center justify-center text-gray-400 hover:text-white transition-colors"
