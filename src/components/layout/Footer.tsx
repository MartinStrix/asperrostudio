          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400 mb-6">
                ...
                <li>
                  <a href={`tel:${CONTACT_INFO.phone.replace(/\s/g, '')}`} className="hover:text-cyan-400 transition-colors">
                    {CONTACT_INFO.phone}
                  </a>
                </li>
              </ul>
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-gray-400 hover:bg-gradient-to-r hover:from-cyan-400 hover:to-pink-500 hover:text-white transition-all"
