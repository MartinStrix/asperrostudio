...
export const KontaktPage = () => {
  ...
  const getAriaDescribedBy = () => {
    if (formState.isError) return 'form-error';
    if (formState.isSuccess) return 'form-success';
    return undefined;
  };
          ...
          >
            ...
            <div className="p-6 md:p-8 rounded-2xl bg-white/5 border border-white/10">
              ...
              {formState.isSuccess && (
                ...
                >
                  <CheckCircleIcon className="w-6 h-6 text-green-400 flex-shrink-0" aria-hidden="true" />
              ...
              {formState.isError && (
                ...
                >
                  <ExclamationCircleIcon className="w-6 h-6 text-red-400 flex-shrink-0" aria-hidden="true" />
              ...
              >
                ...
                >
                  <label htmlFor="_honeypot">Nevyplňujte toto pole</label>
                  <input
                    type="text"
                    id="_honeypot"
                    name="_honeypot"
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    aria-required="true"
                    aria-invalid={formState.isError && !formData.name.trim()}
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    aria-required="true"
                    aria-invalid={formState.isError && !formData.email.trim()}
                    className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    aria-required="true"
                    aria-invalid={formState.isError && !formData.message.trim()}
                    rows={5}
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="group relative w-12 h-12 rounded-xl bg-white/5 overflow-hidden flex items-center justify-center text-gray-400 hover:text-white transition-colors"
                    aria-label="Instagram"
                  >
                    <span aria-hidden="true" className="absolute inset-0 bg-gradient-to-br from-cyan-400 to-pink-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
