...
// Ikony kategorií (podle pořadí v PRICING_CATEGORIES)
              ...
              <div key={s} className="flex items-center gap-2">
                <div
                  className={`px-3 py-1.5 rounded-full text-xs font-medium border transition-colors ${
                    i === stepIndex
                      ? 'border-transparent text-white bg-gradient-to-r from-cyan-400 to-pink-500'
                      : i < stepIndex
            ...
            <AnimatePresence mode="wait">
              ...
              {step === 'tier' && category && (
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <h2 className="text-xl font-bold font-display mb-5 text-center">
                    {category.tierTitle}
                  </h2>
              ...
              {step === 'addons' && category && tier && (
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <h2 className="text-xl font-bold font-display mb-1 text-center">
                    Volitelné doplňky
                  </h2>
